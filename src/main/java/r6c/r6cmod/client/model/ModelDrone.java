...
public class ModelDrone extends ModelBase {
    ...
    public ModelDrone()
    {
        ...
        leftWheel.setTextureSize(256, 128);
        ...
        rightWheel.setTextureSize(256, 128);
        ...
        outerBase.setTextureSize(256, 128);
