...
public class ChannelBackDriveAnimation extends Channel {

    public ChannelBackDriveAnimation(String _name, float _fps, int _totalFrames, byte _mode) {
